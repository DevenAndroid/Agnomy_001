...
class Dimensions {
  ...
  static double fontSizeMedium = Get.context!.width >= 1300 ? 17 : 15;
  ...
  static double fontSizeSmallQuad = Get.context!.width >= 1300 ? 14 : 14;
  static double fontSizeDefaultQuad = Get.context!.width >= 1300 ? 16 : 16;
  static double fontSizeBanner= Get.context!.width >= 1300 ? 36 : 36;
  ...
  static const double paddingSizeMid = 60.0;
  static const double paddingSizeDouble = 80.0;
  static const double paddingForChattingButton = 60.0;
  static const double pagesBottomPadding = 100.0;

  static const double quadSectionPadding = 35.0;
  static const double quadIconSize = 35.0;
  ...
  static const double radiusDefault = 5.0;
  ...
  static const double webExtraMaxWidth = 1600;
  ...
  static const double webLandingTwoSection = 400;
  static const double webLandingBannerHeight = 220;
  static const double webSectionRoundHeight = 100;
  ...
  static const double webLandingSectionWidth = 600;

  static const double featureSectionImageSize = 512;
  static const double bannerSectionImageSize = 400;
