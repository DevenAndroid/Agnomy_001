                            ...
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: index != int.parse(subCategoryIndex!) ? Theme.of(context).hoverColor : Theme.of(context).hintColor,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(categoryController.categoryList![index].name!,
                                          style: ubuntuRegular.copyWith(
                                              ...
                                              color:index==int.parse(subCategoryIndex!)? Theme.of(context).primaryColorDark:Theme.of(context).primaryColorDark
                                          ),
                  ...
                  SliverToBoxAdapter(
                    child: SizedBox(width: Dimensions.webMaxWidth,
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'sub_categories'.tr, style: ubuntuTitleMD.copyWith(fontSize: Dimensions.fontSizeDefault,
                              color:Get.isDarkMode ? Colors.white:Theme.of(context).colorScheme.tertiary),
                          ),
                        ),
                      ),
                    ),
