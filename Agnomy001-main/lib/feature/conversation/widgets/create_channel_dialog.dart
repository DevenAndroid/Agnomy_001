      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
            ...
            bottomLeft: ResponsiveHelper.isDesktop(context)?const Radius.circular(10):const Radius.circular(0),
            bottomRight: ResponsiveHelper.isDesktop(context)?const Radius.circular(10):const Radius.circular(0),
          ),
        ),
