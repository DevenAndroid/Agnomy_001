        ...
        appBar:ResponsiveHelper.isWeb() ? CustomAppBar(title:"${widget.name}\n+${widget.phone}",): AppBar(
          leading: IconButton(onPressed: () {
            if(widget.formNotification == "fromNotification"){
              Get.offNamed(RouteHelper.getInboxScreenRoute(fromNotification: widget.formNotification));
            }else{
              Get.back();
            }
          },
          ...
          title: Text(
              "${widget.name}"
                  ...
                  && Get.find<SplashController>().configModel.content?.phoneNumberVisibility==0?"": "\n+${widget.phone}"}",
