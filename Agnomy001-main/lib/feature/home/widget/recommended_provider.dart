          ...
          if(providerBookingController.providerList != null){
            return Container(
              ...
              child: Stack(children: [
                Image.asset(Images.homeProviderBackground,height: Get.find<LocalizationController>().isLtr? 230:230,width: Get.width,fit: BoxFit.cover,),
                Column(children: [
                  Padding(
                  ...
                  SizedBox(height: ResponsiveHelper.isMobile(context)? 170: 180,
