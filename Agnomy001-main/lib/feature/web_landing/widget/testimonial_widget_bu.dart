                ...
                Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Column( mainAxisSize: MainAxisSize.min,  crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(textContent?['testimonial_title']??"",
                        style: ubuntuTitle.copyWith(fontSize: Dimensions.fontSizeOverLarge), textAlign: TextAlign.center,
                      ),
                      ...
                      Text("${testimonial.designation!}",
                        style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,
                      ),
                    ]),
